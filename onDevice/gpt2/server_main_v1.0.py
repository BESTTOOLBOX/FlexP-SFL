...
def deal_recv(clientdata):
    global client_activation, client_grad, client_mask, client_activation_num, client_grad_num, client_mask_num, client_grad_stamp
    if clientdata['key']=='client_top_activation':
        client_activation.append(clientdata['data'])
        client_activation_num.append(clientdata['client'])
        return 0
    if clientdata['key']=='client_top_mask':
        client_mask.append(clientdata['data'])
        client_mask_num.append(clientdata['client'])
        return 0
