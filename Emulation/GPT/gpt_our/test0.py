...
def split_gpt2_model(model, split_start, split_end):
    ...
    client_bottom = nn.Sequential(*list(model.transformer.h[split_end:]), model.transformer.ln_f, model.lm_head)
...
for round in range(num_rounds):  # Number of communication rounds
    ...
    for i in range(num_clients):
        ...
        full_model_2 = assemble_full_model(3, 22, i).to(device)
        print("===========================")
        print(round, i)
        print(full_model)
